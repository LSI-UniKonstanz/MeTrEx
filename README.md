...
MeTrEx (**Me**mbrane **Tr**ajectory **Ex**ploration) is a Python program for visualising molecular simulation data from membranes interacting with small molecules (ligands). 
